...
module.exports = function() {
	 ...
	 * @param {Boolean} roundDown - if true, the line pixel value is rounded down when its fractional portion is equal to 0.5.
	 * @returns {Number} The aligned line pixel value.
	 */
	helpers.alignLinePixel = function(linePixel, lineWidth, roundDown) {
		if (Math.floor(lineWidth) !== lineWidth) {
			return linePixel;
		}
		return Math.round(linePixel - lineWidth / 2 - (roundDown ? 1e-13 : 0)) + lineWidth / 2;
	};
