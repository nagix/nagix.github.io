...
module.exports = function(Chart) {
	...
	function drawPointLabels(scale) {
		...
		if (ctx.setLineDash) {
			ctx.setLineDash(helpers.valueOrDefault(angleLineOpts.borderDash, globalDefaults.borderDash));
			ctx.lineDashOffset = helpers.valueOrDefault(angleLineOpts.borderDashOffset, globalDefaults.borderDashOffset);
		}
	...
	function drawRadiusLine(scale, gridLineOpts, radius, index) {
		...
		if (ctx.setLineDash) {
			ctx.setLineDash(helpers.valueOrDefault(gridLineOpts.borderDash, globalDefaults.borderDash));
			ctx.lineDashOffset = helpers.valueOrDefault(gridLineOpts.borderDashOffset, globalDefaults.borderDashOffset);
		}
